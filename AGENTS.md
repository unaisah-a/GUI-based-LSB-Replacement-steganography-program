...
- Respect the user's latest authorized task scope. The current handoff is T02 only; do not start T03-T09 without a subsequent user instruction authorizing further work.
