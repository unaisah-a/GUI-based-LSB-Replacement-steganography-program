...
- Respect the user's latest authorised task scope. T08 is complete with the documented pytest-qt logging-capture mitigation. Do not start T09 without further authorisation.
