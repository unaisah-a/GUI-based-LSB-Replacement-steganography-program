...
- Respect the user's latest authorised task scope. The current handoff is T07 complete; do not start T08-T09 without a subsequent user instruction authorising further work.
