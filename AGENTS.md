...
- Respect the user's latest authorized task scope. The current handoff is T04 only; do not start T05-T09 without a subsequent user instruction authorizing further work.
